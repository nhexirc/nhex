...
const UserInput = ({ nick, isNight }) => {
  ...
  let prefix = "";
  return (
    <input type="text" className={`${TOPIC_USER_INPUT} ${UNIFORM_BORDER_STYLE} ${isNight ? `placeholder:text-white/60 text-white/90` : `placeholder:text-black/60 text-black`} focus:outline-none`} autoFocus placeholder={nick} onKeyDown={(e) => {
      if (e.key === "Tab") {
