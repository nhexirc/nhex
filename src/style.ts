...
//CONNECT COMPONENT
export const CONNECT_STYLE = "max-w-7xl mx-auto bg-zinc-500/30 rounded-lg p-2 min-w-[420px] shadow-xl"
...
export const SERVER_NAMES_PANEL_STYLE = "bg-zinc-600/60 w-full sm:min-w-32 sm:w-32 px-2 overflow-x-auto overflow-y-auto scrollbar-thin h-24 sm:h-[600px] border-x border-y sm:border-b"
