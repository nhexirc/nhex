...
export const MESSAGES = "bg-zinc-600/30 w-screen flex flex-col justify-between font-mono h-screen overflow-y-auto scrollbar-thin overflow-x-hidden border sm:border-0"
